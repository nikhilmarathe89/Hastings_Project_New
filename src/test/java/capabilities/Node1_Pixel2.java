...
public class Node1_Pixel2 
{	
	public AndroidDriver<AndroidElement> json_reader_Node1(AndroidDriver<AndroidElement> driver) throws JsonParseException, JsonMappingException, IOException, InterruptedException
	{
        ...
        URL url = new URL("http://192.168.1.3:4733/wd/hub");
